...
private fun TransferProgressTimelineRow(
    ...
    Row(
        ...
        Box(
            ...
            val bgColor =
                when (state) {
                    TransferRowState.DONE -> ZappTheme.colors.success
                    TransferRowState.ATTENTION -> ZappTheme.colors.accent
                    TransferRowState.ACTIVE -> ZappTheme.colors.accent
                    TransferRowState.IDLE -> ZappTheme.colors.surfaceAlt
                }
            val textColor =
                when (state) {
                    TransferRowState.ATTENTION, TransferRowState.ACTIVE -> ZappTheme.colors.onAccent
                    TransferRowState.DONE, TransferRowState.IDLE -> ZappTheme.colors.textSubtle
                }
            Box(
                modifier =
                    Modifier
                        ...
                        .border(2.dp, ZappTheme.colors.bg, RectangleShape),
