...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            val kmpBignumVersion = extra["KMP_BIGNUM_VERSION"].toString()
            val kmpCryptographyVersion = extra["KMP_CRYPTOGRAPHY_VERSION"].toString()
            val kmpSecp256k1Version = extra["KMP_SECP256K1_VERSION"].toString()
            ...
            library("firebase-messaging", "com.google.firebase", "firebase-messaging").withoutVersion()
            ...
            library("ktor-darwin", "io.ktor" ,"ktor-client-darwin").withoutVersion()
            ...
            library("kmp-bignum", "com.ionspin.kotlin:bignum:$kmpBignumVersion")
            library("kmp-cryptography-core", "dev.whyoleg.cryptography:cryptography-core:$kmpCryptographyVersion")
            library(
                "kmp-cryptography-provider",
                "dev.whyoleg.cryptography:cryptography-provider-optimal:$kmpCryptographyVersion",
            )
            library("kmp-cryptography-random", "dev.whyoleg.cryptography:cryptography-random:$kmpCryptographyVersion")
            library("kmp-secp256k1", "fr.acinq.secp256k1:secp256k1-kmp:$kmpSecp256k1Version")
