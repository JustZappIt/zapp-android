...
pluginManager.withPlugin("com.android.application") {
    project.the<com.android.build.gradle.AppExtension>().apply {
        ...
        defaultConfig {
            ...
            // Indonesian is shipped under both the legacy code ("in", used by Android <= 14) and the
            // BCP-47 code ("b+id", used by Android 15+); both must be whitelisted here or they are stripped.
            resourceConfigurations.addAll(
                listOf("en", "en-rUS", "en-rGB", "en-rAU", "es", "pt", "in", "b+id", "en_XA", "ar_XB")
            )
