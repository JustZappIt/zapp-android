...
internal sealed class RequestState {
    ...
    data class QrCode(
        ...
        val onClose: () -> Unit,
        val zcashCurrency: ZcashCurrency,
        val onSendInChat: () -> Unit,
        val chatPicker: RequestChatPickerState?,
    ) : Prepared(onBack) {
        fun toQrState(
...
internal data class RequestChatPickerState(
    val contacts: List<RequestChatContactItem>,
    val isSending: Boolean,
    val onDismiss: () -> Unit,
)

internal data class RequestChatContactItem(
