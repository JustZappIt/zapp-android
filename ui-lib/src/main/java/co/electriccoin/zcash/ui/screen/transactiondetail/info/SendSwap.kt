        ...
        TransactionDetailInfoContainer {
            ...
            AnimatedVisibility(
                ...
                Column {
                    ...
                    state.totalFeesUsd?.let {
                        ZashiHorizontalDivider(thickness = 2.dp)
                        TransactionDetailInfoRow(
                            modifier = Modifier.fillMaxWidth(),
                            state =
                                TransactionDetailInfoRowState(
                                    title = stringRes(R.string.transaction_detail_info_total_fees_usd),
                                    message = it.withStyle(),
                                )
                        )
                    }
                    state.exchangeRate?.let {
                        ...
                        TransactionDetailInfoRow(
                            ...
                            state =
                                TransactionDetailInfoRowState(
                                    title = stringRes(R.string.transaction_detail_info_exchange_rate),
                                    message = it.withStyle(),
                                )
                        )
                    }
            ...
            SendSwap(
                state =
                    SendSwapState(
                        ...
                        totalFees = null,
                        exchangeRate = stringRes("1 ZEC = 35.42 USDC"),
                        totalFeesUsd = stringRes("$0.12"),
