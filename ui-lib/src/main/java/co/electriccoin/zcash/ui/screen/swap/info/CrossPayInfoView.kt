...
/**
 * Explains what "the recipient gets exactly X" means: which leg NEAR guarantees, and that an
 * under-delivered swap is reversed and refunded rather than partially settled.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CrossPayInfoView(state: CrossPayInfoState) {
...
@PreviewScreens
@Composable
private fun Preview() = ZcashTheme { CrossPayInfoView(state = CrossPayInfoState(onBack = {})) }
