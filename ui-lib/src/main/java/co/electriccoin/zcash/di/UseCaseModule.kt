...
val useCaseModule =
    module {
        ...
        factoryOf(::RestoreWalletAndNavigateUseCase)
        ...
        factoryOf(::GetOfframpBaseAddressUseCase)
        ...
        factoryOf(::GetChatContactsUseCase)
        factoryOf(::SendChatMessageUseCase)
        factoryOf(::SendChatMediaMessageUseCase)
        factoryOf(::GetChatConnectionDetailsUseCase)
        factoryOf(::RenameChatGroupUseCase)
        factoryOf(::AddChatGroupMemberUseCase)
        factoryOf(::CreateChatGroupUseCase)
        factoryOf(::ObserveChatMediaTransferProgressUseCase)
        factoryOf(::ResolveChatConversationForAddressUseCase)
        factoryOf(::GetOrCreateChatConversationUseCase)
    }
